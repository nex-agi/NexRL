...
"""
HTTP Train Service Client

This module provides a client class for interacting with the train service via HTTP.
...
class HTTPTrainServiceClient(TrainServiceClient):
    """Client for interacting with train service via HTTP"""
