...
class DataParallelPPOActor:
    ...
    def __init__(
        ...
        self.compute_entropy_from_logits = torch.compile(nx_utils.entropy_from_logits, dynamic=True)
    ...
    def update_policy(self, data: DataProto):
        ...
        if self.config.do_old_log_prob_compute:
        ...
        for epoch in range(self.config.ppo_epochs):
            ...
            for batch_idx, mini_batch in enumerate(dataloader):
                ...
                for micro_batch_data in micro_batches:
                    ...
                    first_1000_entropy_loss, last_1000_entropy_loss = compute_edge_entropy_loss(
                    ...
                    if self.config.use_dynamic_bsz:
                        ...
                        loss = policy_loss * (
                            len(micro_batch_data) / self.config.ppo_mini_batch_size
                        )
                    else:
