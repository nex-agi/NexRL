...
Uses public images (`nexagi/nexrl:v1.3.0`, `lmsysorg/sglang:v0.5.4.post2`) and `/tmp` storage - perfect for testing!
...
- `NEXRL_WORKER_IMAGE`: Worker image (default: `nexagi/nexrl:v1.3.0`)
- `NEXRL_CONTROLLER_IMAGE`: Controller image (default: `nexagi/nexrl:v1.3.0`)
